...
from mazegen.algorithm.recursive_backtracker import RBacktrackerAlgorithm
...
ALGORITHM_MAP: dict[MazeAlgorithm, MazeAlgorithmStrategy] = {
    ...
    MazeAlgorithm.DFS: RBacktrackerAlgorithm(),
...
def get_algorithm(
    ...
    try:
        ...
        raise ValueError(
            f"Algorithm for name '{name}' not implemented"
        )
